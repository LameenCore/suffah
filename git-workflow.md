...
- Commit at the end of every completed checklist item in `TASKS.md`, not just at the end of a phase — small, frequent commits mean you can always roll back to a working state if something breaks close to demo time
